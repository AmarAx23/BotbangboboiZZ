...
{{
  ...
  "category": "หมวดหมู่แบบสั้นๆ 1-2 คำ เช่น ประชุม, ตรวจสอบ, คำสั่ง, หนังสือเวียน, อื่นๆ ถ้าพอเดาได้ ไม่งั้นใส่ null",
  "assignee": "ชื่อ/รหัสคนที่ถูกมอบหมาย/รับผิดชอบ ถ้าพูดถึงชัดเจน (เช่น \"มอบหมายให้เวร 70\") ไม่งั้นใส่ null - อย่าเอาชื่อผู้ประสานงาน/ผู้ให้ข้อมูลติดต่อมาใส่ตรงนี้"
}}
...
เวลาที่พูดแบบ "เก้าโมงสามสิบ" หรือเขียนแบบ "09.30 น." ให้ตีความเป็น 09:30
...
ถ้ามีการพูดปีเป็น พ.ศ. (ตัวเลขมากกว่า 2400) ให้แปลงเป็น ค.ศ. โดยลบ 543 ก่อนแปลงเป็น YYYY-MM-DD
